          ...
          <div>
            ...
            <form action={handleLogin} className="space-y-5">
              ...
              <Button
                ...
                disabled={process.env.NEXT_PUBLIC_GOOGLE_AUTH_ENABLED !== 'true'}
                className="w-full bg-[#111] border-white/10 text-white py-6 rounded-none font-medium hover:bg-white/5 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
              >
