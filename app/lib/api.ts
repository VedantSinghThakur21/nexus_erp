...
/**
 * Make request with API credentials (for admin/system operations)
...
export async function frappeRequest(endpoint: string, method = 'GET', body: any = null) {
  if (!API_KEY || !API_SECRET) {
    throw new Error('API credentials not configured. Check ERP_API_KEY and ERP_API_SECRET in .env')
  }
