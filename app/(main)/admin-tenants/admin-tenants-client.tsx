                  ...
                  <div>
                    ...
                    <CardDescription>
                      <div className="space-y-1 mt-2">
                        ...
                        <div><strong>Site URL:</strong> <a href={`https://${tenant.site_url}`} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">{tenant.site_url}</a></div>
