...
export default function CTASection() {
  return (
    <section className="py-40 relative overflow-hidden flex flex-col items-center justify-center text-center">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] bg-background/5 rounded-full blur-[50px]" />
      ...
      <div className="relative z-10">
        ...
        <Link
          href="/signup"
          className="group relative inline-flex items-center justify-center px-12 py-6 bg-background text-black rounded-full font-bold text-lg tracking-tight overflow-hidden transition-transform hover:scale-110 duration-500 shadow-[0_0_60px_-15px_rgba(255,255,255,0.5)]"
        >
