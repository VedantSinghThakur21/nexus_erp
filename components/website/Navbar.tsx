    ...
    <nav className="fixed w-full z-40 top-0 border-b border-white/5 bg-[#050505]/80 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3 group cursor-pointer">
          <div className="w-8 h-8 bg-background/5 border border-white/10 flex items-center justify-center relative overflow-hidden group-hover:border-orange-500/50 transition-colors duration-500">
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/login"
            className="hidden sm:flex px-4 py-2 text-xs font-mono font-medium text-white bg-background/5 border border-white/10 hover:bg-background/10 hover:border-white/20 transition-all items-center gap-2"
          >
          ...
          <Link
            href="/signup"
            className="px-4 py-2 text-xs font-mono font-medium text-black bg-background hover:bg-neutral-200 transition-all flex items-center gap-2"
          >
            GET STARTED
