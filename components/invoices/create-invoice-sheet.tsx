  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent className="overflow-y-auto sm:max-w-[900px] w-full bg-slate-50 dark:bg-slate-950 border-l border-slate-200 dark:border-slate-800 p-0">
        ...
        {/* Sticky Header */}
        <div className="sticky top-0 z-10 bg-card dark:bg-background border-b border-slate-200 dark:border-slate-800 px-6 py-4 flex justify-between items-center">
            <div>
            ...
            <Button type="submit" onClick={handleSubmit} disabled={loading} className="bg-background text-white hover:bg-slate-800 dark:bg-slate-100 ">
        ...
        <div className="px-6 py-6 space-y-8">
          ...
          {/* Category Filter */}
          <div className="bg-card dark:bg-background rounded-lg border border-slate-200 dark:border-slate-800 p-4">
            <div className="flex items-center gap-4">
              ...
              <Select value={selectedItemGroup} onValueChange={setSelectedItemGroup}>
                <SelectTrigger className="w-[250px] bg-background border-border/60 focus-visible:border-primary focus-visible:ring-0 focus-visible:ring-offset-0">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
              ...
              <p className="text-xs text-muted-foreground">Items will be filtered by selected category</p>
            </div>
          </div>
          ...
          <div className="bg-card dark:bg-background p-4 rounded-lg border border-slate-200 dark:border-slate-800 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="grid gap-1.5 md:col-span-2">
                    <Label htmlFor="customer" className="text-xs text-muted-foreground">Customer Name <span className="text-red-500">*</span></Label>
                    <Input 
                        id="customer" 
                        value={customer} 
                        onChange={(e) => setCustomer(e.target.value)} 
                        placeholder="Search Customer..." 
                        className="bg-yellow-50/50 border-yellow-200 focus-visible:ring-yellow-200 text-slate-900 dark:text-foreground" 
                    />
                </div>

                <div className="grid gap-1.5">
                    <Label htmlFor="date" className="text-xs text-muted-foreground">Invoice Date</Label>
                    <Input 
                        id="date" 
                        type="date" 
                        value={date} 
                        onChange={(e) => setDate(e.target.value)} 
                        className="bg-slate-50 dark:bg-background border-slate-200 dark:border-slate-800"
                    />
                </div>
                ...
                <div className="grid gap-1.5">
                    ...
                    <Select value={placeOfSupply} onValueChange={setPlaceOfSupply}>
                        <SelectTrigger className="h-9 bg-slate-50 border-slate-200 bg-background border-border/60 focus-visible:border-primary focus-visible:ring-0 focus-visible:ring-offset-0">
                            <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
          ...
          <div className="bg-card dark:bg-background p-4 rounded-lg border border-slate-200 dark:border-slate-800 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <Select value={selectedItemGroup} onValueChange={setSelectedItemGroup}>
                  <SelectTrigger className="h-8 w-[200px] text-xs bg-background border-border/60 focus-visible:border-primary focus-visible:ring-0 focus-visible:ring-offset-0">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
            ...
            <div className="border border-slate-200 dark:border-slate-800 rounded-md overflow-hidden">
                {/* Table Header */}
                <div className="grid grid-cols-12 gap-2 bg-slate-100 dark:bg-slate-800 text-xs font-medium text-muted-foreground py-2 px-3 border-b border-slate-200 dark:border-slate-700">
                ...
                {/* Table Rows */}
                <div className="divide-y divide-slate-100 dark:divide-slate-800 bg-card dark:bg-background">
                    {items.map((item, index) => (
                        <div key={item.id} className="grid grid-cols-12 gap-2 px-3 py-2 items-start hover:bg-slate-50/50 dark:hover:bg-slate-800/50 group">
                            ...
                            <div className="col-span-2 pt-2 text-right text-sm font-medium text-slate-700 ">
          ...
          <div className="bg-card dark:bg-background p-6 rounded-lg border border-slate-200 dark:border-slate-800 shadow-sm">
             <div className="flex flex-col gap-3 max-w-sm ml-auto">
                ...
                <div className="flex justify-between items-center border-t border-border/40 dark:border-slate-800 pt-3 mt-2">
