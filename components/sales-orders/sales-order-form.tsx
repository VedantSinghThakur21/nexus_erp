        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <select
                className="w-full mt-1 px-3 py-2 bg-background border border-border/60 rounded-lg focus-visible:border-primary focus-visible:ring-0 focus-visible:ring-offset-0"
            ...
            <div>
              ...
              {showNewTerritory ? (
                <div className="flex gap-2 mt-1">
                  <input
                    type="text"
                    className="flex-1 px-3 py-2 bg-background border border-border/60 rounded-lg text-sm focus-visible:border-primary focus-visible:ring-0 focus-visible:ring-offset-0"
                  ...
                  return (
                    <React.Fragment key={index}>
                      <tr className="border-b border-border/40">
                        ...
                        <td className="py-2 px-2">
                          <select
                            className="w-full px-2 py-1 text-sm bg-background border border-border/60 rounded focus-visible:border-primary focus-visible:ring-0 focus-visible:ring-offset-0"
