...
export function LeadsDashboard({ leads, opportunities, atRiskDeals, recentActivities }: LeadsDashboardProps) {
  ...
  return (
    <div className="bg-muted text-foreground min-h-screen flex flex-col overflow-hidden">
      {/* Header */}
      <PageHeader
          ...
          <div className="grid grid-cols-12 gap-8">
            ...
            <div className="col-span-12 xl:col-span-8 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* Sales Funnel */}
                <div className="bg-card p-7 rounded-2xl border border-border shadow-sm">
                ...
                <div className="bg-card p-7 rounded-2xl border border-border shadow-sm">
                  ...
                  <div className="flex items-center justify-around h-full pb-6">
                    ...
                    <div className="relative w-40 h-40">
                      ...
                      ></div>
                      <div className="absolute inset-5 bg-card rounded-full flex flex-col items-center justify-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 pb-6">
              {recentActivities.length > 0 ? recentActivities.map((activity, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="bg-card rounded-2xl border border-border shadow-sm p-6 hover:shadow-md transition-shadow w-full"
                  >
